                 ...
                 <div class="col-lg-6 align-self-center ltn__upcoming-project-item">
                    <div class="about-us-info-wrap">
                        <div class="section-title-area ltn__section-title-2--- mb-30">
                            ...
                            <h1 class="section-title">Dasre Investments</h1>
                            <p>Dasre Investments, is a privately held investment firm focused on acquiring stable, income producing multi-family properties in emerging U.S. markets.
                        ...
                        <div class="ltn__feature-item ltn__feature-item-3">
                            ...
                            <div class="ltn__feature-info">
                                <h4><a href="service-details.html">High Cash on Cash Returns</a></h4>
                                <p></p>
                            </div>
                        </div>
                        <div class="ltn__feature-item ltn__feature-item-3">
                            ...
                            <div class="ltn__feature-info">
                                <h4><a href="service-details.html">Wealth Creation and Control</a></h4>
                                <p></p>
                            </div>
                        </div>
                        <div class="ltn__feature-item ltn__feature-item-3">
                            ...
                            <div class="ltn__feature-info">
                                <h4><a href="service-details.html">Growing Demand for Multifamily Niche</a></h4>
                                <p></p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="ltn__upcoming-project-area section-bg-1--- bg-image-top pt-115 pb-65" data-bs-bg="img/bg/22.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2--- text-center---">                        
                        <h1 class="section-title  white-color">Our Portfolio</h1>
                    </div>
                </div>
            </div>
